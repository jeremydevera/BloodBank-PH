angular.module('bloodinventoryControllers', [])

// Controller: User to control the management page and managing of user accounts
.controller('bloodinventoryCtrl', function(Bloodinventory,$scope) {
    var app = this;
    ...
    function getBloodinventory() {
        ...
        Bloodinventory.getUsers().then(function(data) {
            // Check if able to get data from database
            if (data.data.success) {
                app.bloodinventories = data.data.bloodinventories; // Assign users from database to variable       
            } else {
