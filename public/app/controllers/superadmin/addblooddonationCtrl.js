angular.module('addblooddonationControllers', ['blooddonationServices'])

    .controller('addblooddonationCtrl', function($http, $location, $timeout, Blooddonation, $route) {

        var app = this;

        // Function to submit form and register account
        app.regBlooddonation = function(regData) {
            ...
            Blooddonation.create(app.regData).then(function(data) {
