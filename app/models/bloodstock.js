...
var BloodstocktSchema = new Schema({
...
BloodstocktSchema.pre('save', function(next) {
    var bloodstock = this;

});
module.exports = mongoose.model('Bloodstock', BloodstocktSchema); // Export User Model for us in API
